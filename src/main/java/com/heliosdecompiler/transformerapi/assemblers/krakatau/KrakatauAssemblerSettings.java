...
public class KrakatauAssemblerSettings extends KrakatauSettings {
    @Override
    public KrakatauAssemblerSettings setPythonExecutable(File location) {
        super.setPythonExecutable(location);
        return this;
    }

    @Override
    public KrakatauAssemblerSettings setProcessCreator(ExceptionalFunction<ProcessBuilder, Process, IOException> creator) {
