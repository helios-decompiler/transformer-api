...
public abstract class Disassembler<SettingType> {
     ...
     * @return The result
     */
    public final TransformationResult<String> disassemble(FileContents data) throws TransformationException {
     ...
     * @return The result
     */
    public final TransformationResult<String> disassemble(FileContents data, SettingType settings) throws TransformationException {
     ...
     * @return The result
     */
    public final TransformationResult<String> disassemble(FileContents data, SettingType settings, Collection<FileContents> classpath) throws TransformationException {
     ...
     * @return The result
     */
    public final TransformationResult<String> disassemble(Collection<FileContents> data, SettingType settings, Collection<FileContents> classpath) throws TransformationException {
        Map<String, FileContents> map = new HashMap<>();
        classpath.forEach(classData -> map.put(classData.getName(), classData));
     ...
     * @return The result
     */
    public abstract TransformationResult<String> disassemble(Collection<FileContents> data, SettingType settings, Map<String, FileContents> classpath) throws TransformationException;
