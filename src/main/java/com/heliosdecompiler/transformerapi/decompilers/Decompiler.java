...
public abstract class Decompiler<SettingType> {
     ...
     * @return The result
     */
    public final Result decompile(ClassData data) throws TransformationException {
     ...
     * @return The result
     */
    public final Result decompile(ClassData data, SettingType settings) throws TransformationException {
     ...
     * @return The result
     */
    public final Result decompile(ClassData data, SettingType settings, Collection<ClassData> classpath) throws TransformationException {
     ...
     * @return The result
     */
    public final Result decompile(Collection<ClassData> data, SettingType settings, Collection<ClassData> classpath) throws TransformationException {
        Map<String, ClassData> map = new HashMap<>();
        classpath.forEach(classData -> map.put(classData.getInternalName(), classData));
     ...
     * @return The result
     */
    public abstract Result decompile(Collection<ClassData> data, SettingType settings, Map<String, ClassData> classpath) throws TransformationException;
